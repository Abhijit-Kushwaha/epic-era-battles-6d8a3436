...
export const ERAS: Era[] = [
  ...
  },
  {
    id: "modern",
    name: "Modern Era",
    subtitle: "1900 AD – 2100 AD",
    description: "Soldiers with advanced firearms dominate the battlefield",
    bgImage: arenaFuture,
    color: "hsl(120, 30%, 40%)",
    fighters: [
      {
      ...
      },
      {
        ...
        defense: 22,
        speed: 4,
        specialName: "Explosive Charge",
        specialDamage: 55,
        color: "#6b5b3a",
      },
    ],
    facts: [
      { era: "modern", fact: "The internet was originally a military project called ARPANET, created in 1969.", lesson: "Many everyday technologies started as military inventions." },
      { era: "modern", fact: "Modern body armor can stop a bullet traveling at 2,500 feet per second.", lesson: "Defense technology evolves alongside offensive capability." },
      { era: "modern", fact: "GPS satellites orbit at 20,200 km altitude and are accurate to within 30 cm.", lesson: "Precision technology has transformed both warfare and daily life." },
      { era: "modern", fact: "The SR-71 Blackbird could fly at Mach 3.3 — faster than a rifle bullet.", lesson: "Human engineering can push beyond seemingly impossible limits." },
    ],
  },
  {
    id: "future",
